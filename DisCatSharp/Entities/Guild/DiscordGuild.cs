...
public partial class DiscordGuild : SnowflakeObject, IEquatable<DiscordGuild>
{
	...
	public IReadOnlyDictionary<ulong, DiscordRole> Roles
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordRole>(CacheLocation.Roles, this.Id).OrderBy(y => y.Id).ToDictionary(x => x.Id, x => x);
	...
	public IReadOnlyDictionary<ulong, DiscordSticker> Stickers
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordSticker>(CacheLocation.Stickers, this.Id).OrderBy(y => y.Id).ToDictionary(x => x.Id, x => x);
	...
	public IReadOnlyDictionary<ulong, DiscordEmoji> Emojis
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordEmoji>(CacheLocation.Emojis, this.Id).OrderBy(y => y.Id).ToDictionary(x => x.Id, x => x);
	...
	public IReadOnlyDictionary<ulong, DiscordVoiceState> VoiceStates
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordVoiceState>(CacheLocation.VoiceStates, this.Id).OrderBy(y => y.UserId).ToDictionary(x => x.UserId, x => x);
	...
	public IReadOnlyDictionary<ulong, DiscordMember> Members
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordMember>(CacheLocation.Members, this.Id).OrderBy(y => y.Id).ToDictionary(x => x.Id, x => x);
	...
	public IReadOnlyDictionary<ulong, DiscordChannel> Channels
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordChannel>(CacheLocation.Channels, this.Id).OrderBy(y => y.Id).ToDictionary(x => x.Id, x => x);
	...
	/// </summary>
	[JsonIgnore]
	public IReadOnlyDictionary<ulong, DiscordThreadChannel> Threads
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordThreadChannel>(CacheLocation.Threads, this.Id).OrderBy(y => y.Id).ToDictionary(x => x.Id, x => x);
	...
	/// </summary>
	[JsonIgnore]
	public IReadOnlyDictionary<ulong, DiscordStageInstance> StageInstances
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordStageInstance>(CacheLocation.StageInstances, this.Id).OrderBy(y => y.Id).ToDictionary(x => x.Id, x => x);
	...
	/// </summary>
	[JsonIgnore]
	public IReadOnlyDictionary<ulong, DiscordScheduledEvent> ScheduledEvents
		=> this.Discord.CacheProvider.GetAllFiltered<DiscordScheduledEvent>(CacheLocation.ScheduledEvents, this.Id).OrderBy(y => y.Id).ToDictionary(x => x.Id, x => x);
	...
	{
		IReadOnlyList<DiscordChannel> rawChannels = this.Discord.CacheProvider.GetAllFiltered<DiscordChannel>(CacheLocation.Channels, this.Id);
