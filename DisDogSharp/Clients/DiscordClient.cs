...
using DisDogSharp.Net.Serialization;
...
using DisDogSharp.Net.Abstractions;
using DisDogSharp.Net.Models;
...
#region Public REST Methods
	...
	/// </summary>
	/// <param name="scopes">The scopes to send with the request. Defaults to <see cref="OAuthScopes.BOT_DEFAULT"/>. Mutually exclusive to <paramref name="manual_scopes"/>.</param>
