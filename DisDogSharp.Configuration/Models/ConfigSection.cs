...
namespace DisDogSharp.Configuration.Models;
...
internal readonly struct ConfigSection
{
	...
	/// <param name="rootName">(Optional) Indicates <paramref name="sectionName"/> is nested within this name. Default value is DisDogSharp</param>
	public ConfigSection(ref IConfiguration config, string sectionName, string? rootName = "DisDogSharp")
	{
		this.Config = config;
