...
using DisDogSharp.Configuration;
using DisDogSharp.Configuration.Models;
...
internal static class ConfigurationExtensions
{
	...
	public static Dictionary<string, ExtensionConfigResult> FindImplementedExtensions(
		...
		string rootName = DisDogSharp.Configuration.ConfigurationExtensions.DEFAULT_ROOT_LIB
	)
	{
