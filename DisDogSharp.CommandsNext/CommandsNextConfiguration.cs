...
using DisDogSharp.CommandsNext.Attributes;
using DisDogSharp.Entities;

using Microsoft.Extensions.DependencyInjection;

namespace DisDogSharp.CommandsNext;
...
public sealed class CommandsNextConfiguration
{
	...
	/// <para>
	/// Modifying default help can be achieved via custom help formatters (see <see cref="DisDogSharp.CommandsNext.Converters.BaseHelpFormatter"/> and <see cref="CommandsNextExtension.SetHelpFormatter{T}()"/> for more details).
