...
using DisDogSharp.Lavalink.Entities.Filters;
using DisDogSharp.Lavalink.Enums;
using DisDogSharp.Lavalink.Exceptions;
...
internal sealed class LavalinkRestClient
{
	...
	internal LavalinkRestClient(LavalinkConfiguration configuration, DiscordClient client)
	{
		...
		this.HttpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", $"DisDogSharp.Lavalink/{this.Discord.VersionString}");
