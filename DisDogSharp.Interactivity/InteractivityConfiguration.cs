...
using DisDogSharp.Interactivity.Enums;
using DisDogSharp.Interactivity.EventHandling;
...
public sealed class InteractivityConfiguration
{
	...
	/// <summary>
	/// The message to send to the user when processing invalid interactions. Ignored if <see cref="ResponseBehavior"/> is not set to <see cref="DisDogSharp.Interactivity.Enums.InteractionResponseBehavior.Respond"/>.
	/// </summary>
